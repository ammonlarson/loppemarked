...
export const I18N_KEYS = {
  ...
  registration: {
    ...
    tableLabel: "registration.tableLabel",
  ...
  validation: {
    ...
    tableIdInvalid: "validation.tableIdInvalid",
  },
  consent: {
    title: "consent.title",
  ...
  admin: {
    ...
    registrationsTableSize: "admin.registrations.tableSize",
    ...
    waitlistAssignTableId: "admin.waitlist.assignTableId",
    waitlistConfirmAssign: "admin.waitlist.confirmAssign",
    tablesTitle: "admin.tables.title",
    tablesNumber: "admin.tables.number",
    tablesSize: "admin.tables.size",
    tablesState: "admin.tables.state",
    registrationsSelectTable: "admin.registrations.selectTable",
  },
} as const;
